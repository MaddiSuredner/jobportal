	    ...
	    return (
			...
			<form onSubmit= {this.contactSubmit.bind(this)}>
				 <div className="form-group row">
				    <label for="jobtitle" className="col-sm-2 col-form-label">Job Title</label>
				    ...
				    <small id="jobtitle" class="form-text text-danger">{this.state.errors["jobtitle"]}</small>
				  </div>
				  <div className="form-group row">
				    <label for="jobdesc" className="col-sm-2 col-form-label">Job Description</label>
				     <div className="col-sm-5">
				     <textarea onChange={this.handleChange.bind(this, "jobdesc")} ></textarea>
				     </div>
				    <small id="jobdesc" class="form-text text-danger">{this.state.errors["jobtitle"]}</small>
				  </div>
				  <div className="form-group row">
...
const PostJobContainer = connect(mapStateToProps)(PostJob);
